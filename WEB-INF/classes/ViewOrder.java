...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<h1 class='mb-3 bread'>View Order</h1>");
		pw.print("<p class='breadcrumbs'><span class='mr-2'><a href='Home'>Home <i class='ion-ios-arrow-forward'></i></a></span> <span>ViewOrder<i class='ion-ios-arrow-forward'></i></span></p></div></div></div>");
				...
				for (OrderPayment oi : orderPayments.get(orderId)) 
					{
							if(oi.getOrderName().equals(orderName) && (oi.getUserName().equals(username) || request.getParameter("cust_order").equals("cust")))
							{
								...
								// response.setContentType("text/html");
								pw.print("<h4 class='alert' style='color:red'>Your Order is Cancelled</h4>");	
								break;							
							}
					}
