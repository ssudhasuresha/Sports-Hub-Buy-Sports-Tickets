...
public class WriteReview extends HttpServlet {
	...
	protected void review(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      // on filling the form and clicking submit button user will be directed to submit review page
		...
		pw.print("<h1 class='mb-3 bread'>Write Your Review</h1>");
		...
		pw.print("<h2 class='mb-4'></h2><div class='GameList'><div class='row d-flex'> ");
		pw.print("<form name ='WriteReview' action='SubmitReview' method='post'>");
		...
		pw.print("<input type='hidden' name='productmaker' value='"+productmaker+"'>");
				...
				pw.print("<td><input type='radio' name='gender' value='male'>Male<br><input type='radio' name='gender' value='female'>Female<br><input type='radio' name='gender' value='other'>Other</td>");
				// pw.print("<td><input type='radio' name='gender' value='female'>Female</td>");
				// pw.print("<td><input type='radio' name='gender' value='other'>Other</td>");
                ...
                pw.print("</form></div></div></div></div></section>"); 		
