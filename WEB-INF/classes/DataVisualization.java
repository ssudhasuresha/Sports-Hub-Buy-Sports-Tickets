...
public class DataVisualization extends HttpServlet {
    ...
    protected void displayPage(HttpServletRequest request, HttpServletResponse response, PrintWriter pw)
        ...
        pw.print("<h1 class='mb-3 bread'>Data Visualisation</h1>");
        pw.print("<p class='breadcrumbs'><span class='mr-2'><a href='Home'>Home <i class='ion-ios-arrow-forward'></i></a></span> <span>DataVisualization<i class='ion-ios-arrow-forward'></i></span></p></div></div></div>");
        ...
        pw.println("<script type='text/javascript' src='js/DataVisualization.js'></script>");
