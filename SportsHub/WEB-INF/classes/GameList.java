...
public class GameList extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (utility.usertype().equals("manager")){
            pw.print("<h3 class='mb-4' style='margin-left:30rem;'><a href='EventModify?button=Addevent' style='font-size: 23px;padding: 10px;background: #6c757d;border-radius: 4px;'>Add Event</a><br></h3>");
        }
    }
